...
- Text / outline / script / storyboard: `google/gemini-3.5-flash` (OpenRouter)
- Images (components): `google/gemini-3-pro-image` (OpenRouter)
- Images (storyboard): `google/gemini-3.1-flash-image` (OpenRouter, 75% cheaper)
